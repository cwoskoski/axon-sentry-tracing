...
## Overview
Create comprehensive Spring Boot auto-configuration to enable zero-configuration setup of axon-sentry-tracing in Spring Boot applications. This includes auto-configuration, configuration properties, conditional beans, health indicators, actuator metrics integration, Spring Boot starter module, tests, and documentation. This makes the library production-ready for Spring Boot applications with sensible defaults and easy customization.

**Note:** This issue consolidates what was previously Phase 2 (Issues 021-028) into a single comprehensive Spring Boot integration.
