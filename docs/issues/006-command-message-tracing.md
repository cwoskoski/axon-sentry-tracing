# Issue 006: Command Message Tracing
...
## Overview
Implement command tracing using the centralized AxonSpanFactory with advanced features like result correlation, retry tracing, and aggregate lifecycle integration. This provides production-ready command tracing with comprehensive observability.

## Goals
- Implement command interceptors using AxonSpanFactory
